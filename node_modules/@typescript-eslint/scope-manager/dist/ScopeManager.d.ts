...
import { BlockScope, CatchScope, ClassScope, ConditionalTypeScope, ForScope, FunctionExpressionNameScope, FunctionScope, FunctionTypeScope, GlobalScope, MappedTypeScope, ModuleScope, SwitchScope, TSEnumScope, TSModuleScope, TypeScope, WithScope } from '../src/scope';
import { ClassFieldInitializerScope } from '../src/scope/ClassFieldInitializerScope';
import { ClassStaticBlockScope } from '../src/scope/ClassStaticBlockScope';
